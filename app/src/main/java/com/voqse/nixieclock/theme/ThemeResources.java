...
public class ThemeResources {
    ...
    private Bitmap decodeBitmap(@NonNull Theme theme, String fileName, BitmapFactory.Options options) {
        ...
        InputStream in = null;
        try {
            in = openBitmapStream(theme, assetsName);
    ...
    private InputStream openBitmapStream(@NonNull Theme theme, String assetsName) throws IOException {
        try {
            if (theme.encryptedResources) {
