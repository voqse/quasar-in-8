...
public class DrawerNew extends Drawer {
    ...
    private final ThemeResourcesNew themeResources;

    public DrawerNew(Context context) {
        super(context);
        this.themeResources = new ThemeResourcesNew(context);
    ...
    private Bitmap getDigit(Theme theme, String text, int index, boolean x2) {
        ...
        return themeResources.getDigit(theme, digit, index, x2);
    }
}
